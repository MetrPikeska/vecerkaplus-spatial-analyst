...
python3 analyze_network.py    # OSMnx izodistance → data/osm_isochrones.geojson + output/network_analyza.html
python3 simulate_monte_carlo.py  # Monte Carlo P&L → output/monte_carlo_summary.json
